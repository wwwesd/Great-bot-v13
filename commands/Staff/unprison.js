...
module.exports = {
    ...
    execute(client,Message,args){
      if(!Message.member.permissions.has('ADMINISTRATOR')) return;  
         ...
         if(target){
             let mainrole= Message.guild.roles.cache.find(roles => roles.id === '826459803936096327');//هنا حط ايدي رتبة الميوت
             let mainrole2= Message.guild.roles.cache.find(roles => roles.id === '826459803936096327');
             let muterole3= Message.guild.roles.cache.find(roles => roles.id === '826459803936096327');
